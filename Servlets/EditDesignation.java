...
pw.println("{");
pw.println("document.getElementById('cancelEditing').submit();");
pw.println("}");
...
pw.println("<form method='post' action='/styleone/updateDesignation' onsubmit='return validateForm(this)'>Designation<input type='text' id='title' name='title' maxlength='35' size='36' value='"+designation.getTitle()+"'>");
...
pw.println("<form id='cancelEditing' action='/styleone/designationsView'></form>");
pw.println("</body>");
pw.println("</html>");
